package ru.aasmc.xpensemanager.presentation.components
...
/**
 * A chart that animates when loaded.
 */
@Composable
fun AnimatedCircle(
    ...
    val transition =
        updateTransition(currentState, label = "AnimatedCircleTransitionLabel")
